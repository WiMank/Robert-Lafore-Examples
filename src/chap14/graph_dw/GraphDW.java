...
public class GraphDW extends Applet implements Runnable, ActionListener, MouseListener {
    ...
    public void init() {
        ...
        this.pathButton = new Button("Path");
        var2.add(this.pathButton);
    ...
    public void actionPerformed(ActionEvent var1) {
        ...
        if (var1.getSource() == this.pathButton) {
            this.theVertexGroup.path();
            this.wasClearPressed = false;
        }
